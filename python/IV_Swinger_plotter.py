...
# and they must all be in the expected format. The resulting PDF (or
# GIF) files are written to the directory in which the program is run.
#
...
class IV_Swinger_extended(IV_Swinger.IV_Swinger):
    ...
    def plot_graphs(self, args, csv_proc):
        ...
        if args.overlay:
            ...
            self.plt_img_filename = "overlaid" + plt_img_file_suffix
